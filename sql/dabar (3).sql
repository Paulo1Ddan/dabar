...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19-Jul-2022 às 13:15
...
(1, 'Paulo Daniel', 'pdaniel@gmail.com', '(11) 99999-9999', 'dc2b76bf56e43fef073d67d331ca83211ef5bd16', '2002-05-10', 'default.svg', '2022-05-10', 1, 1),
(2, 'Paulo Daniel Nascimento da Palma', 'paulodaniel1360@gmail.com', '(11) 93054-6947', 'd8f43252968b2794392185c7d97732de14f003c0', '2002-05-10', 'nezuko.jpg', '2022-05-19', 1, 1),
(11, 'Fernando Miguel', 'fernando.miguel@gmail.com', '(11) 92038-2019', '3b3caf9ce9f9453b3dca6f27d0b6bba9d39c308b', '1998-06-28', 'fernando-miguel.jpg', '2022-06-28', 1, 1),
(12, 'Giga Chad', 'gigachad@gmail.com', '(11) 93020-4444', 'f5204929651ea7b7c0daa9e1e531123b254200a7', '2001-06-28', 'default.svg', '2022-06-28', 1, 1),
(13, 'Fernando Miguel', 'fernandomiguel@gmail.com', '(11) 93030-3030', 'b4e194df52d1da41a1a2ea681703a07e90556885', '2003-06-02', 'default.svg', '2022-07-18', 1, 1),
(14, 'Fernando Miguel', 'sla@gmail.com', '(11)99999-9999', 'e8c18e810e0ef8369424c1789d48bb8102c518fd', '2004-02-11', 'default.svg', '2022-07-18', 1, 1);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `artigoatual`  AS SELECT `artigo`.`idArtigo` AS `COD. ARTIGO`, `artigo`.`tituloArtigo` AS `TITULO`, `artigo`.`imgCapa` AS `CAPA`, `artigo`.`imgBanner` AS `BANNER`, `artigo`.`artigo` AS `ARTIGO`, `artigo`.`dataArtigo` AS `DT. ARTIGO` FROM `artigo` ORDER BY `artigo`.`dataArtigo` DESC ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `contatoatual`  AS SELECT `contato`.`idContato` AS `COD. CONTATO`, `contato`.`nomeContato` AS `NOME`, `contato`.`emailContato` AS `email`, `contato`.`telefoneContato` AS `TELEFONE`, `contato`.`mensagemContato` AS `MENSAGEM`, `contato`.`dataContato` AS `DT. CONTATO` FROM `contato` ORDER BY `contato`.`dataContato` DESC ;
